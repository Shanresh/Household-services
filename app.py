...
import io
app.secret_key = 'Optimusprimemegatronsoundwave'
create_tables()
...
def admin_dashboard():
    ...
    return render_template('admin_dashboard.html',servicerequest=servicerequests,Customers=customers, Professionals=professionals, services=services,username=username)
